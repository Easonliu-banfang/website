...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _getBlurShader(e,t,r){return new i.BKk({name:"SphericalGaussianBlur",defines:{SAMPLES:20,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/r,CUBEUV_MAX_MIP:"".concat(e,".0")},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:_getCommonVertexShader(),fragmentShader:`
...
`)}let D={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function getToneMappingFunction(e,t){let r=D[t];return void 0===r?((0,i.R8M)("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+e+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+e+"( vec3 color ) { return "+r+"ToneMapping( color ); }"}let I=new i.Pq0;function getLuminanceFunction(){i.ppV.getLuminanceCoefficients(I);let e=I.x.toFixed(4),t=I.y.toFixed(4),r=I.z.toFixed(4);return["float luminance( const in vec3 rgb ) {","	const vec3 weights = vec3( ".concat(e,", ").concat(t,", ").concat(r," );"),`	return dot( weights, rgb );
}`].join(`
...
`)+`
`+s);let x=T+o+f,R=T+s+p,b=WebGLShader(d,d.VERTEX_SHADER,x),A=WebGLShader(d,d.FRAGMENT_SHADER,R);function onFirstUse(t){if(e.debug.checkShaderErrors){let r=d.getProgramInfoLog(M)||"",a=d.getShaderInfoLog(b)||"",n=d.getShaderInfoLog(A)||"",l=r.trim(),c=a.trim(),u=n.trim(),f=!0,p=!0;if(!1===d.getProgramParameter(M,d.LINK_STATUS))if(f=!1,"function"==typeof e.debug.onShaderError)e.debug.onShaderError(d,M,b,A);else{let e=getShaderErrors(d,b,"vertex"),r=getShaderErrors(d,A,"fragment");(0,i.z3S)("WebGLProgram: Shader Error "+d.getError()+" - VALIDATE_STATUS "+d.getProgramParameter(M,d.VALIDATE_STATUS)+`
...
Program Info Log: `+l+`
`+e+`
`+r)}else""!==l?(0,i.R8M)("WebGLProgram: Program Info Log:",l):(""===c||""===u)&&(p=!1);p&&(t.diagnostics={runnable:f,programLog:l,vertexShader:{log:c,prefix:o},fragmentShader:{log:u,prefix:s}})}d.deleteShader(b),d.deleteShader(A),l=new WebGLUniforms(d,M),c=fetchAttributeLocations(d,M)}d.attachShader(M,b),d.attachShader(M,A),void 0!==r.index0AttributeName?d.bindAttribLocation(M,0,r.index0AttributeName):!0===r.hasPositionAttribute&&d.bindAttribLocation(M,0,"position"),d.linkProgram(M),this.getUniforms=function(){return void 0===l&&onFirstUse(this),l},this.getAttributes=function(){return void 0===c&&onFirstUse(this),c};let C=!1===r.rendererExtensionParallelShaderCompile;return this.isReady=function(){return!1===C&&(C=d.getProgramParameter(M,37297)),C},this.destroy=function(){n.releaseStatesOfProgram(this),d.deleteProgram(M),this.program=void 0},this.type=r.shaderType,this.name=r.shaderName,this.id=U++,this.cacheKey=t,this.usedTimes=1,this.program=M,this.vertexShader=b,this.fragmentShader=A,this}let H=0;let WebGLShaderCache=class WebGLShaderCache{update(e,t,r){let i=this._getShaderCacheForMaterial(e);return!1===i.has(t)&&(i.add(t),t.usedTimes++),!1===i.has(r)&&(i.add(r),r.usedTimes++),this}remove(e){for(let t of this.materialCache.get(e))t.usedTimes--,0===t.usedTimes&&this.shaderCache.delete(t.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,r=t.get(e);return void 0===r&&(r=new Set,t.set(e,r)),r}_getShaderStage(e){let t=this.shaderCache,r=t.get(e);return void 0===r&&(r=new WebGLShaderStage(e),t.set(e,r)),r}constructor(){this.shaderCache=new Map,this.materialCache=new Map}};let WebGLShaderStage=class WebGLShaderStage{constructor(e){this.id=H++,this.code=e,this.usedTimes=0}};function isPackedRGFormat(e){return 1030===e||37490===e||36285===e}function WebGLPrograms(e,t,r,a,n,s){let l=new i.zgK,c=new WebGLShaderCache,d=new Set,u=[],f=new Map,p=a.logarithmicDepthBuffer,m=a.precision,h={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function getChannel(e){return(d.add(e),0===e)?"uv":"uv".concat(e)}function getProgramCacheKeyParameters(e,t){e.push(t.precision),e.push(t.outputColorSpace),e.push(t.envMapMode),e.push(t.envMapCubeUVHeight),e.push(t.mapUv),e.push(t.alphaMapUv),e.push(t.lightMapUv),e.push(t.aoMapUv),e.push(t.bumpMapUv),e.push(t.normalMapUv),e.push(t.displacementMapUv),e.push(t.emissiveMapUv),e.push(t.metalnessMapUv),e.push(t.roughnessMapUv),e.push(t.anisotropyMapUv),e.push(t.clearcoatMapUv),e.push(t.clearcoatNormalMapUv),e.push(t.clearcoatRoughnessMapUv),e.push(t.iridescenceMapUv),e.push(t.iridescenceThicknessMapUv),e.push(t.sheenColorMapUv),e.push(t.sheenRoughnessMapUv),e.push(t.specularMapUv),e.push(t.specularColorMapUv),e.push(t.specularIntensityMapUv),e.push(t.transmissionMapUv),e.push(t.thicknessMapUv),e.push(t.combine),e.push(t.fogExp2),e.push(t.sizeAttenuation),e.push(t.morphTargetsCount),e.push(t.morphAttributeCount),e.push(t.numSunLights),e.push(t.numDirLights),e.push(t.numPointLights),e.push(t.numSpotLights),e.push(t.numSpotLightMaps),e.push(t.numHemiLights),e.push(t.numRectAreaLights),e.push(t.numSunLightShadows),e.push(t.numDirLightShadows),e.push(t.numPointLightShadows),e.push(t.numSpotLightShadows),e.push(t.numSpotLightShadowsWithMaps),e.push(t.numLightProbes),e.push(t.shadowMapType),e.push(t.toneMapping),e.push(t.numClippingPlanes),e.push(t.numClipIntersection),e.push(t.depthPacking)}function getProgramCacheKeyBooleans(e,t){l.disableAll(),t.instancing&&l.enable(0),t.instancingColor&&l.enable(1),t.instancingMorph&&l.enable(2),t.matcap&&l.enable(3),t.envMap&&l.enable(4),t.normalMapObjectSpace&&l.enable(5),t.normalMapTangentSpace&&l.enable(6),t.clearcoat&&l.enable(7),t.iridescence&&l.enable(8),t.alphaTest&&l.enable(9),t.vertexColors&&l.enable(10),t.vertexAlphas&&l.enable(11),t.vertexUv1s&&l.enable(12),t.vertexUv2s&&l.enable(13),t.vertexUv3s&&l.enable(14),t.vertexTangents&&l.enable(15),t.anisotropy&&l.enable(16),t.alphaHash&&l.enable(17),t.batching&&l.enable(18),t.dispersion&&l.enable(19),t.retroreflection&&l.enable(24),t.batchingColor&&l.enable(20),t.gradientMap&&l.enable(21),t.packedNormalMap&&l.enable(22),t.vertexNormals&&l.enable(23),e.push(l.mask),l.disableAll(),t.fog&&l.enable(0),t.useFog&&l.enable(1),t.flatShading&&l.enable(2),t.logarithmicDepthBuffer&&l.enable(3),t.reversedDepthBuffer&&l.enable(4),t.skinning&&l.enable(5),t.morphTargets&&l.enable(6),t.morphNormals&&l.enable(7),t.morphColors&&l.enable(8),t.premultipliedAlpha&&l.enable(9),t.shadowMapEnabled&&l.enable(10),t.doubleSided&&l.enable(11),t.flipSided&&l.enable(12),t.useDepthPacking&&l.enable(13),t.dithering&&l.enable(14),t.transmission&&l.enable(15),t.sheen&&l.enable(16),t.opaque&&l.enable(17),t.pointsUvs&&l.enable(18),t.decodeVideoTexture&&l.enable(19),t.decodeVideoTextureEmissive&&l.enable(20),t.alphaToCoverage&&l.enable(21),t.numLightProbeGrids>0&&l.enable(22),t.hasPositionAttribute&&l.enable(23),e.push(l.mask)}return{getParameters:function(n,l,u,f,g,_){let v,S,E,M,T=f.fog,x=g.geometry,R=n.isMeshStandardMaterial||n.isMeshLambertMaterial||n.isMeshPhongMaterial?f.environment:null,b=n.isMeshStandardMaterial||n.isMeshLambertMaterial&&!n.envMap||n.isMeshPhongMaterial&&!n.envMap,A=t.get(n.envMap||R,b),C=A&&306===A.mapping?A.image.height:null,P=h[n.type];null!==n.precision&&(m=a.getMaxPrecision(n.precision))!==n.precision&&(0,i.R8M)("WebGLProgram.getParameters:",n.precision,"not supported, using",m,"instead.");let L=x.morphAttributes.position||x.morphAttributes.normal||x.morphAttributes.color,U=void 0!==L?L.length:0,w=0;if(void 0!==x.morphAttributes.position&&(w=1),void 0!==x.morphAttributes.normal&&(w=2),void 0!==x.morphAttributes.color&&(w=3),P){let e=o[P];v=e.vertexShader,S=e.fragmentShader}else{v=n.vertexShader,S=n.fragmentShader;let e=c.getVertexShaderStage(n),t=c.getFragmentShaderStage(n);c.update(n,e,t),E=e.id,M=t.id}let D=e.getRenderTarget(),I=e.state.buffers.depth.getReversed(),N=!0===g.isInstancedMesh,y=!0===g.isBatchedMesh,O=!!n.map,F=!!n.matcap,B=!!A,G=!!n.aoMap,V=!!n.lightMap,H=!!n.bumpMap&&!1===n.wireframe,W=!!n.normalMap,z=!!n.displacementMap,k=!!n.emissiveMap,X=!!n.metalnessMap,q=!!n.roughnessMap,Y=n.anisotropy>0,j=n.clearcoat>0,K=n.dispersion>0,Z=n.retroreflectivity>0,Q=n.iridescence>0,J=n.sheen>0,$=n.transmission>0,ee=Y&&!!n.anisotropyMap,et=j&&!!n.clearcoatMap,er=j&&!!n.clearcoatNormalMap,ei=j&&!!n.clearcoatRoughnessMap,ea=Q&&!!n.iridescenceMap,en=Q&&!!n.iridescenceThicknessMap,eo=J&&!!n.sheenColorMap,es=J&&!!n.sheenRoughnessMap,el=!!n.specularMap,ec=!!n.specularColorMap,ed=!!n.specularIntensityMap,eu=$&&!!n.transmissionMap,ef=$&&!!n.thicknessMap,ep=!!n.gradientMap,em=!!n.alphaMap,eh=n.alphaTest>0,eg=!!n.alphaHash,e_=!!n.extensions,ev=0;n.toneMapped&&(null===D||!0===D.isXRRenderTarget)&&(ev=e.toneMapping);let eS={shaderID:P,shaderType:n.type,shaderName:n.name,vertexShader:v,fragmentShader:S,defines:n.defines,customVertexShaderID:E,customFragmentShaderID:M,isRawShaderMaterial:!0===n.isRawShaderMaterial,glslVersion:n.glslVersion,precision:m,batching:y,batchingColor:y&&null!==g._colorsTexture,instancing:N,instancingColor:N&&null!==g.instanceColor,instancingMorph:N&&null!==g.morphTexture,outputColorSpace:null===D?e.outputColorSpace:!0===D.isXRRenderTarget?D.texture.colorSpace:i.ppV.workingColorSpace,alphaToCoverage:!!n.alphaToCoverage,map:O,matcap:F,envMap:B,envMapMode:B&&A.mapping,envMapCubeUVHeight:C,aoMap:G,lightMap:V,bumpMap:H,normalMap:W,displacementMap:z,emissiveMap:k,normalMapObjectSpace:W&&1===n.normalMapType,normalMapTangentSpace:W&&0===n.normalMapType,packedNormalMap:W&&0===n.normalMapType&&isPackedRGFormat(n.normalMap.format),metalnessMap:X,roughnessMap:q,anisotropy:Y,anisotropyMap:ee,clearcoat:j,clearcoatMap:et,clearcoatNormalMap:er,clearcoatRoughnessMap:ei,dispersion:K,retroreflection:Z,iridescence:Q,iridescenceMap:ea,iridescenceThicknessMap:en,sheen:J,sheenColorMap:eo,sheenRoughnessMap:es,specularMap:el,specularColorMap:ec,specularIntensityMap:ed,transmission:$,transmissionMap:eu,thicknessMap:ef,gradientMap:ep,opaque:!1===n.transparent&&1===n.blending&&!1===n.alphaToCoverage,alphaMap:em,alphaTest:eh,alphaHash:eg,combine:n.combine,mapUv:O&&getChannel(n.map.channel),aoMapUv:G&&getChannel(n.aoMap.channel),lightMapUv:V&&getChannel(n.lightMap.channel),bumpMapUv:H&&getChannel(n.bumpMap.channel),normalMapUv:W&&getChannel(n.normalMap.channel),displacementMapUv:z&&getChannel(n.displacementMap.channel),emissiveMapUv:k&&getChannel(n.emissiveMap.channel),metalnessMapUv:X&&getChannel(n.metalnessMap.channel),roughnessMapUv:q&&getChannel(n.roughnessMap.channel),anisotropyMapUv:ee&&getChannel(n.anisotropyMap.channel),clearcoatMapUv:et&&getChannel(n.clearcoatMap.channel),clearcoatNormalMapUv:er&&getChannel(n.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ei&&getChannel(n.clearcoatRoughnessMap.channel),iridescenceMapUv:ea&&getChannel(n.iridescenceMap.channel),iridescenceThicknessMapUv:en&&getChannel(n.iridescenceThicknessMap.channel),sheenColorMapUv:eo&&getChannel(n.sheenColorMap.channel),sheenRoughnessMapUv:es&&getChannel(n.sheenRoughnessMap.channel),specularMapUv:el&&getChannel(n.specularMap.channel),specularColorMapUv:ec&&getChannel(n.specularColorMap.channel),specularIntensityMapUv:ed&&getChannel(n.specularIntensityMap.channel),transmissionMapUv:eu&&getChannel(n.transmissionMap.channel),thicknessMapUv:ef&&getChannel(n.thicknessMap.channel),alphaMapUv:em&&getChannel(n.alphaMap.channel),vertexTangents:!!x.attributes.tangent&&(W||Y),vertexNormals:!!x.attributes.normal,vertexColors:n.vertexColors,vertexAlphas:!0===n.vertexColors&&!!x.attributes.color&&4===x.attributes.color.itemSize,pointsUvs:!0===g.isPoints&&!!x.attributes.uv&&(O||em),fog:!!T,useFog:!0===n.fog,fogExp2:!!T&&T.isFogExp2,flatShading:!1===n.wireframe&&(!0===n.flatShading||void 0===x.attributes.normal&&!1===W&&(n.isMeshLambertMaterial||n.isMeshPhongMaterial||n.isMeshStandardMaterial||n.isMeshPhysicalMaterial)),sizeAttenuation:!0===n.sizeAttenuation,logarithmicDepthBuffer:p,reversedDepthBuffer:I,skinning:!0===g.isSkinnedMesh,hasPositionAttribute:void 0!==x.attributes.position,morphTargets:void 0!==x.morphAttributes.position,morphNormals:void 0!==x.morphAttributes.normal,morphColors:void 0!==x.morphAttributes.color,morphTargetsCount:U,morphTextureStride:w,numSunLights:l.sun.length,numDirLights:l.directional.length,numPointLights:l.point.length,numSpotLights:l.spot.length,numSpotLightMaps:l.spotLightMap.length,numRectAreaLights:l.rectArea.length,numHemiLights:l.hemi.length,numSunLightShadows:l.sunShadowMap.length,numDirLightShadows:l.directionalShadowMap.length,numPointLightShadows:l.pointShadowMap.length,numSpotLightShadows:l.spotShadowMap.length,numSpotLightShadowsWithMaps:l.numSpotLightShadowsWithMaps,numLightProbes:l.numLightProbes,numLightProbeGrids:_.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:n.dithering,shadowMapEnabled:e.shadowMap.enabled&&u.length>0,shadowMapType:e.shadowMap.type,toneMapping:ev,decodeVideoTexture:O&&!0===n.map.isVideoTexture&&"srgb"===i.ppV.getTransfer(n.map.colorSpace),decodeVideoTextureEmissive:k&&!0===n.emissiveMap.isVideoTexture&&"srgb"===i.ppV.getTransfer(n.emissiveMap.colorSpace),premultipliedAlpha:n.premultipliedAlpha,doubleSided:2===n.side,flipSided:1===n.side,useDepthPacking:n.depthPacking>=0,depthPacking:n.depthPacking||0,index0AttributeName:n.index0AttributeName,extensionClipCullDistance:e_&&!0===n.extensions.clipCullDistance&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(e_&&!0===n.extensions.multiDraw||y)&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:n.customProgramCacheKey()};return eS.vertexUv1s=d.has(1),eS.vertexUv2s=d.has(2),eS.vertexUv3s=d.has(3),d.clear(),eS},getProgramCacheKey:function(t){let r=[];if(t.shaderID?r.push(t.shaderID):(r.push(t.customVertexShaderID),r.push(t.customFragmentShaderID)),void 0!==t.defines)for(let e in t.defines)r.push(e),r.push(t.defines[e]);return!1===t.isRawShaderMaterial&&(getProgramCacheKeyParameters(r,t),getProgramCacheKeyBooleans(r,t),r.push(e.outputColorSpace)),r.push(t.customProgramCacheKey),r.join()},getUniforms:function(e){let t,r=h[e.type];if(r){let e=o[r];t=i.LlO.clone(e.uniforms)}else t=e.uniforms;return t},acquireProgram:function(t,r){let i=f.get(r);return void 0!==i?++i.usedTimes:(i=new WebGLProgram(e,r,t,n),u.push(i),f.set(r,i)),i},releaseProgram:function(e){if(0==--e.usedTimes){let t=u.indexOf(e);u[t]=u[u.length-1],u.pop(),f.delete(e.cacheKey),e.destroy()}},releaseShaderCache:function(e){c.remove(e)},programs:u,dispose:function(){c.dispose()}}}function WebGLProperties(){let e=new WeakMap;return{has:function(t){return e.has(t)},get:function(t){let r=e.get(t);return void 0===r&&(r={},e.set(t,r)),r},remove:function(t){e.delete(t)},update:function(t,r,i){e.get(t)[r]=i},dispose:function(){e=new WeakMap}}}function painterSortStable(e,t){if(e.groupOrder!==t.groupOrder)return e.groupOrder-t.groupOrder;if(e.renderOrder!==t.renderOrder)return e.renderOrder-t.renderOrder;if(e.material.id!==t.material.id)return e.material.id-t.material.id;if(e.materialVariant!==t.materialVariant)return e.materialVariant-t.materialVariant;if(e.z!==t.z)return e.z-t.z;else return e.id-t.id}function reversePainterSortStable(e,t){return e.groupOrder!==t.groupOrder?e.groupOrder-t.groupOrder:e.renderOrder!==t.renderOrder?e.renderOrder-t.renderOrder:e.z!==t.z?t.z-e.z:e.id-t.id}function WebGLRenderList(){let e=[],t=0,r=[],i=[],a=[];function init(){t=0,r.length=0,i.length=0,a.length=0}function materialVariant(e){let t=0;return e.isInstancedMesh&&(t+=2),e.isSkinnedMesh&&(t+=1),t}function getNextRenderItem(r,i,a,n,o,s){let l=e[t];return void 0===l?(l={id:r.id,object:r,geometry:i,material:a,materialVariant:materialVariant(r),groupOrder:n,renderOrder:r.renderOrder,z:o,group:s},e[t]=l):(l.id=r.id,l.object=r,l.geometry=i,l.material=a,l.materialVariant=materialVariant(r),l.groupOrder=n,l.renderOrder=r.renderOrder,l.z=o,l.group=s),t++,l}function push(e,t,n,o,s,l,c){!0===c.reversedDepth&&(s=-s);let d=getNextRenderItem(e,t,n,o,s,l);n.transmission>0?i.push(d):!0===n.transparent?a.push(d):r.push(d)}function unshift(e,t,n,o,s,l){let c=getNextRenderItem(e,t,n,o,s,l);n.transmission>0?i.unshift(c):!0===n.transparent?a.unshift(c):r.unshift(c)}function sort(e,t){r.length>1&&r.sort(e||painterSortStable),i.length>1&&i.sort(t||reversePainterSortStable),a.length>1&&a.sort(t||reversePainterSortStable)}return{opaque:r,transmissive:i,transparent:a,init:init,push:push,unshift:unshift,finish:function(){for(let r=t,i=e.length;r<i;r++){let t=e[r];if(null===t.id)break;t.id=null,t.object=null,t.geometry=null,t.material=null,t.group=null}},sort:sort}}function WebGLRenderLists(){let e=new WeakMap;return{get:function(t,r){let i,a=e.get(t);return void 0===a?(i=new WebGLRenderList,e.set(t,[i])):r>=a.length?(i=new WebGLRenderList,a.push(i)):i=a[r],i},dispose:function(){e=new WeakMap}}}function UniformsCache(){let e={};return{get:function(t){let r;if(void 0!==e[t.id])return e[t.id];switch(t.type){case"SunLight":case"DirectionalLight":r={direction:new i.Pq0,color:new i.Q1f};break;case"SpotLight":r={position:new i.Pq0,direction:new i.Pq0,color:new i.Q1f,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":r={position:new i.Pq0,color:new i.Q1f,distance:0,decay:0};break;case"HemisphereLight":r={direction:new i.Pq0,skyColor:new i.Q1f,groundColor:new i.Q1f};break;case"RectAreaLight":r={color:new i.Q1f,position:new i.Pq0,halfWidth:new i.Pq0,halfHeight:new i.Pq0}}return e[t.id]=r,r}}}function ShadowUniformsCache(){let e={};return{get:function(t){let r;if(void 0!==e[t.id])return e[t.id];switch(t.type){case"SunLight":case"DirectionalLight":case"SpotLight":r={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new i.I9Y};break;case"PointLight":r={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new i.I9Y,shadowCameraNear:1,shadowCameraFar:1e3}}return e[t.id]=r,r}}}let W=0;function shadowCastingAndTexturingLightsFirst(e,t){return 2*!!t.castShadow-2*!!e.castShadow+ +!!t.map-!!e.map}function WebGLLights(e){let t=new UniformsCache,r=ShadowUniformsCache(),a={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let e=0;e<9;e++)a.probe.push(new i.Pq0);let o=new i.Pq0,s=new i.kn4,l=new i.kn4;return{setup:function(i){let o=0,s=0,l=0;for(let e=0;e<9;e++)a.probe[e].set(0,0,0);let c=0,d=0,u=0,f=0,p=0,m=0,h=0,g=0,_=0,v=0,S=0,E=0,M=0,T=0;i.sort(shadowCastingAndTexturingLightsFirst);for(let e=0,n=i.length;e<n;e++){let n=i[e],x=n.color,R=n.intensity,b=n.distance,A=null;if(n.shadow&&n.shadow.map&&(A=1030===n.shadow.map.texture.format?n.shadow.map.texture:n.shadow.map.depthTexture||n.shadow.map.texture),n.isAmbientLight)o+=x.r*R,s+=x.g*R,l+=x.b*R;else if(n.isLightProbe){for(let e=0;e<9;e++)a.probe[e].addScaledVector(n.sh.coefficients[e],R);T++}else if(n.isSunLight){let e=t.get(n);if(e.color.copy(n.color).multiplyScalar(n.intensity),n.castShadow){let e=n.shadow,t=r.get(n);t.shadowIntensity=e.intensity,t.shadowBias=e.bias,t.shadowNormalBias=e.normalBias,t.shadowRadius=e.radius,t.shadowMapSize.copy(e.mapSize).multiply(e.getFrameExtents()),a.sunShadow[d]=t,a.sunShadowMap[d]=A;let i=e.getViewportCount();for(let t=0;t<i;t++)a.sunShadowMatrix[u+t]=e.getMatrix(t),a.sunShadowCascade[u+t]=e._cascadeData[t];u+=i,d++}a.sun[c]=e,c++}else if(n.isDirectionalLight){let e=t.get(n);if(e.color.copy(n.color).multiplyScalar(n.intensity),n.castShadow){let e=n.shadow,t=r.get(n);t.shadowIntensity=e.intensity,t.shadowBias=e.bias,t.shadowNormalBias=e.normalBias,t.shadowRadius=e.radius,t.shadowMapSize=e.mapSize,a.directionalShadow[f]=t,a.directionalShadowMap[f]=A,a.directionalShadowMatrix[f]=n.shadow.matrix,_++}a.directional[f]=e,f++}else if(n.isSpotLight){let e=t.get(n);e.position.setFromMatrixPosition(n.matrixWorld),e.color.copy(x).multiplyScalar(R),e.distance=b,e.coneCos=Math.cos(n.angle),e.penumbraCos=Math.cos(n.angle*(1-n.penumbra)),e.decay=n.decay,a.spot[m]=e;let i=n.shadow;if(n.map&&(a.spotLightMap[E]=n.map,E++,i.updateMatrices(n),n.castShadow&&M++),a.spotLightMatrix[m]=i.matrix,n.castShadow){let e=r.get(n);e.shadowIntensity=i.intensity,e.shadowBias=i.bias,e.shadowNormalBias=i.normalBias,e.shadowRadius=i.radius,e.shadowMapSize=i.mapSize,a.spotShadow[m]=e,a.spotShadowMap[m]=A,S++}m++}else if(n.isRectAreaLight){let e=t.get(n);e.color.copy(x).multiplyScalar(R),e.halfWidth.set(.5*n.width,0,0),e.halfHeight.set(0,.5*n.height,0),a.rectArea[h]=e,h++}else if(n.isPointLight){let e=t.get(n);if(e.color.copy(n.color).multiplyScalar(n.intensity),e.distance=n.distance,e.decay=n.decay,n.castShadow){let e=n.shadow,t=r.get(n);t.shadowIntensity=e.intensity,t.shadowBias=e.bias,t.shadowNormalBias=e.normalBias,t.shadowRadius=e.radius,t.shadowMapSize=e.mapSize,t.shadowCameraNear=e.camera.near,t.shadowCameraFar=e.camera.far,a.pointShadow[p]=t,a.pointShadowMap[p]=A,a.pointShadowMatrix[p]=n.shadow.matrix,v++}a.point[p]=e,p++}else if(n.isHemisphereLight){let e=t.get(n);e.skyColor.copy(n.color).multiplyScalar(R),e.groundColor.copy(n.groundColor).multiplyScalar(R),a.hemi[g]=e,g++}}h>0&&(!0===e.has("OES_texture_float_linear")?(a.rectAreaLTC1=n.LTC_FLOAT_1,a.rectAreaLTC2=n.LTC_FLOAT_2):(a.rectAreaLTC1=n.LTC_HALF_1,a.rectAreaLTC2=n.LTC_HALF_2)),a.ambient[0]=o,a.ambient[1]=s,a.ambient[2]=l;let x=a.hash;(x.sunLength!==c||x.directionalLength!==f||x.pointLength!==p||x.spotLength!==m||x.rectAreaLength!==h||x.hemiLength!==g||x.numSunShadows!==d||x.numDirectionalShadows!==_||x.numPointShadows!==v||x.numSpotShadows!==S||x.numSpotMaps!==E||x.numLightProbes!==T)&&(a.sun.length=c,a.directional.length=f,a.spot.length=m,a.rectArea.length=h,a.point.length=p,a.hemi.length=g,a.sunShadow.length=d,a.sunShadowMap.length=d,a.sunShadowMatrix.length=u,a.sunShadowCascade.length=u,a.directionalShadow.length=_,a.directionalShadowMap.length=_,a.directionalShadowMatrix.length=_,a.pointShadow.length=v,a.pointShadowMap.length=v,a.pointShadowMatrix.length=v,a.spotShadow.length=S,a.spotShadowMap.length=S,a.spotLightMatrix.length=S+E-M,a.spotLightMap.length=E,a.numSpotLightShadowsWithMaps=M,a.numLightProbes=T,x.sunLength=c,x.directionalLength=f,x.pointLength=p,x.spotLength=m,x.rectAreaLength=h,x.hemiLength=g,x.numSunShadows=d,x.numDirectionalShadows=_,x.numPointShadows=v,x.numSpotShadows=S,x.numSpotMaps=E,x.numLightProbes=T,a.version=W++)},setupView:function(e,t){let r=0,i=0,n=0,c=0,d=0,u=0,f=t.matrixWorldInverse;for(let t=0,p=e.length;t<p;t++){let p=e[t];if(p.isSunLight){let e=a.sun[r];e.direction.setFromMatrixPosition(p.matrixWorld),e.direction.transformDirection(f),r++}else if(p.isDirectionalLight){let e=a.directional[i];e.direction.setFromMatrixPosition(p.matrixWorld),o.setFromMatrixPosition(p.target.matrixWorld),e.direction.sub(o),e.direction.transformDirection(f),i++}else if(p.isSpotLight){let e=a.spot[c];e.position.setFromMatrixPosition(p.matrixWorld),e.position.applyMatrix4(f),e.direction.setFromMatrixPosition(p.matrixWorld),o.setFromMatrixPosition(p.target.matrixWorld),e.direction.sub(o),e.direction.transformDirection(f),c++}else if(p.isRectAreaLight){let e=a.rectArea[d];e.position.setFromMatrixPosition(p.matrixWorld),e.position.applyMatrix4(f),l.identity(),s.copy(p.matrixWorld),s.premultiply(f),l.extractRotation(s),e.halfWidth.set(.5*p.width,0,0),e.halfHeight.set(0,.5*p.height,0),e.halfWidth.applyMatrix4(l),e.halfHeight.applyMatrix4(l),d++}else if(p.isPointLight){let e=a.point[n];e.position.setFromMatrixPosition(p.matrixWorld),e.position.applyMatrix4(f),n++}else if(p.isHemisphereLight){let e=a.hemi[u];e.direction.setFromMatrixPosition(p.matrixWorld),e.direction.transformDirection(f),u++}}},state:a}}function WebGLRenderState(e){let t=new WebGLLights(e),r=[],i=[],a=[];function init(e){n.camera=e,r.length=0,i.length=0,a.length=0}function pushLight(e){r.push(e)}function pushShadow(e){i.push(e)}function pushLightProbeGrid(e){a.push(e)}function setupLights(){t.setup(r)}function setupLightsView(e){t.setupView(r,e)}let n={lightsArray:r,shadowsArray:i,lightProbeGridArray:a,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:init,state:n,setupLights:setupLights,setupLightsView:setupLightsView,pushLight:pushLight,pushShadow:pushShadow,pushLightProbeGrid:pushLightProbeGrid}}function WebGLRenderStates(e){let t=new WeakMap;return{get:function(r){let i,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,n=t.get(r);return void 0===n?(i=new WebGLRenderState(e),t.set(r,[i])):a>=n.length?(i=new WebGLRenderState(e),n.push(i)):i=n[a],i},dispose:function(){t=new WeakMap}}}let z=`void main() {
	gl_Position = vec4( position, 1.0 );
