...
`];var Pe=1e3,Me=i=>`v${Math.floor(i/100)}.${String(i%100).padStart(2,"0")}`;var nt=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"quoridor-mp.pages.dev",se=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),Vt=se?`ws://${window.location.hostname}:80`:`wss://${nt}`;var k=se?"":"https://quoridor-mp.pages.dev",F=typeof window<"u"&&window.location.hostname.includes("vercel");var Wt=se?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/";var at={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball",sagu:"sagu"},lt=i=>{let e=at[i];return e?a`<img src="assets/${e}.png" alt="${i}" title="${i}" width="18" height="18" style="vertical-align:middle">`:a`🎱`},je=(i,e={})=>a`<span title="${i}">
